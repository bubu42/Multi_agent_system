...
algos = [
    ...
    ["P-DPOP", "frodo2.algorithms.dpop.privacy.P_DPOPsolver", "../agents/DPOP/P-DPOP/P-DPOPagentJaCoP.xml",
     problemFile],
    ["P2-DPOP", "frodo2.algorithms.dpop.privacy.P2_DPOPsolver", "../agents/DPOP/P-DPOP/P2-DPOPagentJaCoP_DisCSP.xml",
     problemFile],
    #
    ...
    #
    ["MPC-DisCSP4", "frodo2.algorithms.mpc_discsp.MPC_DisWCSP4solver", "../agents/MPC/MPC-DisCSP4_JaCoP.xml",
     problemFileMPC],
...
# Plot the graphs
frodo2.plot(output, xCol=7, yCol=11, block=False)  # yCol = 11 is the runtime (the first column has index 0)
frodo2.plot(output, xCol=7, yCol=13, block=True)  # yCol = 13 is the total message size (the first column has index 0)
